                        ...
                        <div class="card-body">
                            <table class="table table-bordered table-striped">
                                <tr>
                                    <th>Thumbnail</th>
                                    <td>
                                        <a href="{{ asset($order->product->thumbnail ?? 'default/logo.png') }}" target="_blank"><img src="{{ asset($order->product->thumbnail ?? 'default/logo.png') }}" alt="" width="50" height="50" class="img-fluid"></a>
                                    </td>
                                </tr>
                                {{-- <tr>
                                    <th>Images</th>
                                ...
                                <tr>
                                    <th>Action</th>
                                    <td>
                                        <button class="btn btn-sm btn-danger" onclick="showDeleteConfirm(`{{ $order->id }}`)">Delete</button>
                                        <button class="btn btn-sm btn-primary" onclick="goToEdit(`{{ $order->id }}`)">Edit</button>
                                    </td>
                                </tr>
                            </table>
