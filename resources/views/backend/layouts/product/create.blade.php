                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number"
                                                        ...
                                                        name="price" placeholder="Enter product price" id="price"
                                             ...
                                             <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number"
                                                        ...
                                                        name="stock" placeholder="Enter here stock of the products" id="stock"
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file"
                                                        ...
                                                        data-default-file="{{ url('default/logo.png') }}" name="thumbnail"
                                                        id="thumbnail">
