    ...
    <div class="app-sidebar" style="overflow: scroll">
        ...
        <div class="main-sidemenu">
            <ul class="side-menu mt-2">
                ...
                <li class="slide">
                    <a class="side-menu__item {{  request()->routeIs('admin.subscriber.index') ? 'has-link active' : '' }}" href="{{ route('admin.subscriber.index') }}">
                    ...
                    <ul class="slide-menu">
                        <li class="sub-slide">
                            ...
                            <ul class="sub-slide-menu">
                                <li><a href="{{ route('admin.cms.home.banner.index') }}" class="sub-slide-item">Banner Section</a></li>
                                <li><a href="{{ route('admin.cms.home.hero.index') }}" class="sub-slide-item">Hero Section</a></li>
                                {{-- <li><a href="{{ route('admin.cms.home.about.index') }}" class="sub-slide-item">About Section</a></li> --}}
                                <li><a href="{{ route('admin.cms.home.supplyment.index') }}" class="sub-slide-item">Supplyment Section</a></li>
                                <li><a href="{{ route('admin.cms.home.what_makes.index') }}" class="sub-slide-item">What Makes Us Different</a></li>
                                <li><a href="{{ route('admin.cms.home.life_without.index') }}" class="sub-slide-item">Physiologically Different</a></li>
                                <li><a href="{{ route('admin.cms.home.education_approach.index') }}" class="sub-slide-item">Education Approach</a></li>
                                <li><a href="{{ route('admin.cms.home.founder_story.index') }}" class="sub-slide-item">Founder Story</a></li>
                                <li><a href="{{ route('admin.cms.home.work_together.index') }}" class="sub-slide-item">Work Together</a></li>
