...
use App\Http\Controllers\Web\Backend\CMS\Web\Home\HomeEducationApproachController;
use App\Http\Controllers\Web\Backend\CMS\Web\Home\HomeExampleController;
use App\Http\Controllers\Web\Backend\CMS\Web\Home\HomeFounderStoryController;
...
use App\Http\Controllers\Web\Backend\CMS\Web\Home\HomeLifeWithoutController;
use App\Http\Controllers\Web\Backend\CMS\Web\Home\HomeSupplymentController;
use App\Http\Controllers\Web\Backend\CMS\Web\Home\HomeWhatMakesController;
use App\Http\Controllers\Web\Backend\CMS\Web\Home\HomeWorkTogetherController;
...
Route::group(['middleware' => ['web-admin']], function () {
    ...
    */
    ...
    Route::prefix('cms')->name('cms.')->group(function () {
        ...
        Route::prefix('home/supplyment')->name('home.supplyment.')->controller(HomeSupplymentController::class)->group(function () {
            Route::get('/', 'index')->name('index');
            Route::get('/{id}/show', 'show')->name('show');
        ...
        Route::prefix('home/life-without')->name('home.life_without.')->controller(HomeLifeWithoutController::class)->group(function () {
            Route::get('/', 'index')->name('index');
            Route::get('/{id}/show', 'show')->name('show');
            Route::put('/status/{id}', 'status')->name('status');
            Route::delete('/delete/{id}', 'destroy')->name('destroy');
        ...
        Route::prefix('home/what-makes')->name('home.what_makes.')->controller(HomeWhatMakesController::class)->group(function () {
            Route::get('/', 'index')->name('index');
            Route::get('/{id}/show', 'show')->name('show');
            Route::put('/status/{id}', 'status')->name('status');
            Route::delete('/delete/{id}', 'destroy')->name('destroy');
        ...
        Route::prefix('home/education-approach')->name('home.education_approach.')->controller(HomeEducationApproachController::class)->group(function () {
            Route::get('/', 'index')->name('index');
            Route::get('/{id}/show', 'show')->name('show');
            Route::put('/status/{id}', 'status')->name('status');
            Route::delete('/delete/{id}', 'destroy')->name('destroy');
